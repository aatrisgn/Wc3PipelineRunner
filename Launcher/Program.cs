...
namespace Launcher
{
	internal static class Program
	{
        ...
        private const string ASSETS_FOLDER_PATH = @"..\..\..\..\source.w3x";
        private const string BASE_MAP_PATH = @"D:\wc3\maps\WCSharpTemplate\source.w3x\terrain.w3x";
		...
		private static void MakeDecision()
		{
			...
			{
				case ConsoleKey.D1:
					ConstantGenerator.Run(ASSETS_FOLDER_PATH, SOURCE_CODE_PROJECT_FOLDER_PATH, new ConstantGeneratorOptions
					{
						IncludeCode = false
					});
					break;
